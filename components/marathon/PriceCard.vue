  ...
  <div class="border-neutral-80 overflow-hidden rounded-xl border">
    <div class="flex w-full bg-white max-md:flex-col">
      <div
        ...
        class="border-neutral-90 w-2/3 border-r p-5 pb-8 max-md:w-full"
      >
        ...
        <ul class="flex flex-col gap-3 text-base">
          ...
          <li>
            {{ t('dates') }}: {{ formatRuMonthDay(firstDay) }} – {{ formatRuMonthDay(lastDay) }},
            {{ getYear(firstDay) }} ({{ price.hotel_number?.night_count }} {{ t('nights') }})
          </li>
    ...
    <UCollapsible>
      <template #content>
        <div
          v-if="price.hotel_number"
          class="border-neutral-90 border-t bg-white p-6"
        >
          <ul>
